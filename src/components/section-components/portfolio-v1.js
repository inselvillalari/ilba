            ...
            <div className="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  ...
                  >
                    <img src={publicUrl + "assets/img/gallery/1.jpg"} alt="#" />
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/3.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/4.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/6.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
            ...
            <div className="ltn__gallery-item filter_category_3 col-lg-4 col-sm-6 col-12">
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  ...
                  >
                    <img src={publicUrl + "assets/img/gallery/7.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/8.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/9.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
                      <i className="fas fa-search" />
                    </span>
                  </a>
              ...
              <div className="ltn__gallery-item-inner">
                <div className="ltn__gallery-item-img">
                  <a
                    ...
                    data-rel="lightcase:myCollection"
                  >
                    <img src={publicUrl + "assets/img/gallery/2.jpg"} alt="#" />
                    <span className="ltn__gallery-action-icon">
                      <i className="fas fa-search" />
                    </span>
                  </a>
